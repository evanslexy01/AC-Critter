...
let month = new Date().getMonth() + 1; //1 through 12
let hour = new Date().getHours(); //0 through 23

let seasonalCritters = CritterInfo.filter(function (el) {
...
let currentCritters = seasonalCritters.filter(function (el) {
